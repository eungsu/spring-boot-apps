...
<div class="container mt-4">
	...
	<form:form action="/posts/create" method="post" class="needs-validation" novalidate="novalidate"
		modelAttribute="postCreateForm" >
		<div class="mb-3">
		...
		<div class="d-grid gap-2 d-md-flex justify-content-md-end">
			...
			<a href="/posts/list" class="btn btn-secondary btn-lg">
